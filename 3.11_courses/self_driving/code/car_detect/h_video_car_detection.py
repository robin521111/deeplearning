...
def video_car_detection(project_video_output = 'F:/dl_data/yolo/project_video_output.mp4', video_input_path = "F:/dl_data/yolo/project_video.mp4"): 
    clip1 = VideoFileClip(video_input_path)
    # project_video_output = "E:/dl_data/yolo/project_video_tesla.mp4"
    # clip1 = VideoFileClip('E:/dl_data/self_driving/epochs/epoch01_front.mp4')
